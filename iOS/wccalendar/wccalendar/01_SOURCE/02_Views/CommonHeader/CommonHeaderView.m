...
-(void)initInterface
{
    ...
    _titleLbl.font = [UIFont fontWithName:FONT_APP_BOLD size:14.0f];
    ...
    _leftLbl.font = [UIFont fontWithName:FONT_APP_THIN size:14.0f];
    _leftLbl.textColor = [UIColor grayColor];
